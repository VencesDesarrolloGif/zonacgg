...
$keyOfFileUpload = "filefotoTarjeta" . $type;
$variable12=explode("/",$_FILES[$keyOfFileUpload]["type"]);
$variable22=$variable12[0];
$variable32=$variable12[1];

$base_file_name = 
    date("Ymd_His") . "_" . 
    sha1(basename($_FILES[$keyOfFileUpload]["name"])) . ".".$variable32;
