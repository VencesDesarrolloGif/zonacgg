...
$datos              = array();
//$log = new KLogger ( "ajax_ActivarSuperUsuario.log" , KLogger::DEBUG );
...
try {
    ...
    $estatusSuperUsuario="2";/* Indica El estatus del usuario indicando que esta bloqueado
    1=Activo
    0=Bloqueo
    2=Reactivado Siguiendo el cataolog estatus empleado
    */
    $sql = "UPDATE superusuarios set UsuarioDesbloqueSuperU='$usuario',FechaDesbloqueSuperU=now(),EstatusSuperU='$estatusSuperUsuario',contraseniaS=md5('$contrasenia')
