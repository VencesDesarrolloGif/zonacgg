...
<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
          <div class="container" align="center"><h1>Catálogo Bancos</h1></div>
          <div id="errorMsg" name="errorMsg"></div>
          <div style="margin-top: 2%"></div>
           <div class="container top-buffer-submenu vertical-buffer" align="center">
            ...
            <script src="catalogoBancos.js"></script>
    </body>
  </html>
