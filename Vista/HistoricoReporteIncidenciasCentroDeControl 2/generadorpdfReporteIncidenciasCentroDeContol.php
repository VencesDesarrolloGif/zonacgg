...
if($RecopilacionIncidenciaCC!=""){
   ...
   $pdf->SetY(86);
   $pdf->MultiCell(126,4.7,"*");//parrafo3
}if($RecopilacionIncidenciaCC4!=""){
   $pdf->SetY(101);
   $pdf->MultiCell(126,4.7,"*");//parrafo4
}if($RecopilacionIncidenciaCC5!=""){
   $pdf->SetY(116);
   $pdf->MultiCell(126,4.7,"*");//parrafo5
}if($RecopilacionIncidenciaCC6!=""){
   $pdf->SetY(131);
   $pdf->MultiCell(126,4.7,"*");//parrafo6
}if($RecopilacionIncidenciaCC7!=""){
   $pdf->SetY(146);
   $pdf->MultiCell(126,4.7,"*");//parrafo7
}if($RecopilacionIncidenciaCC8!=""){
   $pdf->SetY(161);
   $pdf->MultiCell(126,4.7,"*");//parrafo8
}if($RecopilacionIncidenciaCC9!=""){
   $pdf->SetY(176);
   $pdf->MultiCell(126,4.7,"*");//parrafo9
}if($RecopilacionIncidenciaCC10!=""){
   $pdf->SetY(191);
   $pdf->MultiCell(126,4.7,"*");//parrafo10
}if($RecopilacionIncidenciaCC10!=""){
   $pdf->SetY(214);
   $pdf->MultiCell(126,4.7,"*");//tarea
}
$pdf->SetFont("Arial",'B',7);
$pdf->Text(97.5,26,utf8_decode($Tipoinc1));
$pdf->Text(97.5,28,utf8_decode($Tipoinc2));
...
$pdf->SetLeftMargin(78);
$pdf->SetRightMargin(12);
// no se ponen condicines ya que si vienen vacios no mostrará nada
$pdf->SetY(55);
$pdf->MultiCell(126,4.7,$RecopilacionIncidenciaCC);
$pdf->SetY(70);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC2);
$pdf->SetY(85);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC3);
$pdf->SetY(100);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC4);
$pdf->SetY(115);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC5);
$pdf->SetY(130);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC6);
$pdf->SetY(145);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC7);
$pdf->SetY(160);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC8);
$pdf->SetY(175);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC9);
$pdf->SetY(190);
$pdf->MultiCell(126,4.5,$RecopilacionIncidenciaCC10);
$pdf->SetY(213);
$pdf->MultiCell(126,4.5,$TareaIncidenciaCC);
$pdf->SetFont("Arial", 'B', 7.3);
