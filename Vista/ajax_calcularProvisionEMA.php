...
try{
    if($registroConsulta=="TODOS"){
       ...
       $response["datosRegistroP"]=$listaregistrospatronales;
        ...
        for($j = 0; $j < count($listaregistrospatronales); $j++){
            ...
            for ($i = 0; $i < count($listaEmpleados); $i++) {
                ...
                //$log->LogInfo("Valor de variable j1: " . var_export ($j, true));
        ...
        $datosProvision[$registroConsulta]["diasImssTotal"]=$diasImssTotal;
        $datosProvision[$registroConsulta]["sdiTotal"]=$sdiTotal;
        $datosProvision[$registroConsulta]["incapacidadesTotal"]=$incapacidadesTotal;
        $datosProvision[$registroConsulta]["ausentismosTotal"]=$ausentismosTotal;
        $datosProvision[$registroConsulta]["cuotaFijaTotal"]=$cuotaFijaTotal;
        $datosProvision[$registroConsulta]["excPatronTotal"]=$excPatronTotal;
        $datosProvision[$registroConsulta]["excObreroTotal"]=$excObreroTotal;
        $datosProvision[$registroConsulta]["prestDinPatronTotal"]=$prestDinPatronTotal;
        $datosProvision[$registroConsulta]["prestDinObreroTotal"]=$prestDinObreroTotal;
        $datosProvision[$registroConsulta]["gastosMedicosPatronTotal"]=$gastosMedicosPatronTotal;
        $datosProvision[$registroConsulta]["gastosMedicosObreroTotal"]=$gastosMedicosObreroTotal;
        $datosProvision[$registroConsulta]["riesgoTrabajoTotal"]=$riesgoTrabajoTotal;
        $datosProvision[$registroConsulta]["invYvPatronTotal"]=$invYvPatronTotal;
        $datosProvision[$registroConsulta]["invYvObreroTotal"]=$invYvObreroTotal;
        $datosProvision[$registroConsulta]["guarderiasYPenTotal"]=$guarderiasYPenTotal;
        $datosProvision[$registroConsulta]["sumaPatronalTotal"]=$sumaPatronalTotal;
        $datosProvision[$registroConsulta]["sumaObreraTotal"]=$sumaObreraTotal;
        $datosProvision[$registroConsulta]["subTotalTotal"]=$subTotalTotal;
        ...
        $response["datosProvision"]=$datosProvision;
}else{
      $listaEmpleados= $negocio->negocio_obtenerEmpleadosEma($registroConsulta, $fechaPeriodo1, $fechaPeriodo2);
      $datosParaImss = $negocio->negocio_obtenerValoresImssEma($registroConsulta,$mesConsulta,$anio);
      $aguinaldo     = 15 / 365;
