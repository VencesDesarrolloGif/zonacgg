...
try {
    $sql = "SELECT concat(e.entidadFederativaId,'-',e.empleadoConsecutivoId,'-',e.empleadoCategoriaId)AS numempleado,
                   ...
                   e.idTipoPuesto,
                   di.salarioDiario,
                   ng.infonavitNom as infonavit,
                   ng.fonacotNom as fonacot,
                   ng.pensionNom as pension,
                   ng.prestamoNom as prestamo,
                   ng.alimentosNom as alimentos,
            ...
            LEFT JOIN nominageneral ng ON (e.entidadFederativaId=ng.empEntidadNomina AND e.empleadoConsecutivoId=ng.empConsecutivoNomina AND e.empleadoCategoriaId=ng.empTipoNomina) 
            ...
            WHERE ng.numRango='$rango'
            AND ng.idPeriodoNom='$periodo'";
