<div align="center">
  <h2>Subir Permiso Federal</h2>
  <div class="card border-success mb-3" style="max-width: 50rem;">
    <div class="card-header"></div>    
	   <form enctype='multipart/form-data' id='formPermisoF' name='formPermisoF'>
    <div class="card-body text-primary">
			<label class="control-label label" for="permisoF">Selecciona archivo: </label>
          <span class="btn btn-success btn-file" >Examinar
            <input type='file' class='btn-success' id='permisoF' name='permisoF'/>  
          </span>
    </div>            
    </form>
...
<script type="text/javascript">
  ...
  $('#permisoF').change(function(){     
        
        var file = $("#permisoF")[0].files[0];      
        ...
        var formData = new FormData($("#formPermisoF")[0]);
        formData.append('tipo', 'permisoF');
        //var message = ""; 
