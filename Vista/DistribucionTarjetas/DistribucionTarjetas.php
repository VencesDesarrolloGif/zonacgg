    ...
    <body>
        ...
        <div id="LinksUsuarioMatriz" style="display:none">
            <center>
                ...
                <a id="StockTarjetas"onclick="MostrarDivReservados(1)"style="cursor: pointer;display: none;" data-toggle="tab">VER STOCK TARJETAS</a>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                <a id="StockTarjetasGeneral"onclick="MostrarDivReservados(2)"style="cursor: pointer;display: none;" data-toggle="tab">VER STOCK TARJETAS GENERAL</a><br>
            ...
            <center>
                ...
                <div id="TransferirAEntidades" style="display:none">
                    ...
                    <div class="row" id="EntidadesAMandar" style="display:none">
                        ...
                        <div class="row" id="SucursalAMandar" style="display:none">
                            <h4>Seleccione La Sucursal A Transferir</h4>
                            <label class="control-label label" for="SelectSucursalTransferir">Sucursales</label>
                            <select class="span3" id="SelectSucursalTransferir" name="SelectSucursalTransferir"></select>     
                        </div>
                    </div>
                ...
                <div id="TransferirAMatriz" style="display:none">
                    ...
                    <div class="row" id="EntidadesParaMandarAMatriz" >
                        <h4>Seleccione La Entidad De La Que Se Transferirá </h4>
                    ...
                    <div class="row" id="SucursalParaMoverAMatriz" style="display:none">
                        <h4>Seleccione La Sucursal De La Que Se Transferirá </h4>
                        <label class="control-label label" for="SelectSucursalTransferiraMatriz">Sucursales</label>
                        <select class="span3" id="SelectSucursalTransferiraMatriz" name="SelectSucursalTransferiraMatriz"></select>     
                    </div>              
        ...
        <div id="VerStock" style="display:none">
            <center>
                ...
                <div class="row" id="SucursalParaStock" style="display:none">
                        <h4>Seleccione La Sucursal De La Que Se Transferirá </h4>
                        <label class="control-label label" for="SelectSucursalParaStock">Sucursales</label>
                        <select class="span3" id="SelectSucursalParaStock" name="SelectSucursalParaStock"></select>     
                    </div>
        ...
        <div id="VerStockGeneral" style="display:none">
            <center>
                <h2 class="card-title">STOCK DE TARJETAS DE DESPENSA GENERAL</h2>
                <div id="MensajeStockTarjetasGeneral"></div>
                <div class="row" id="EntidadesParaVerStockGeneral" >
                    <h4>Seleccione La Entidad Para Ver Su Stock</h4>
                    <label class="control-label label" for="SelectEntidadStockGeneral">Entidades</label>
                    <select class="span3" id="SelectEntidadStockGeneral" name="SelectEntidadStockGeneral"></select>     
                    <a id="VerConsultaGeneral" onclick="MostrarStockGeneralaaa('General1')"style="cursor: pointer; color: green;" data-toggle="tab">Ver Todas Las Entidades</a>
                </div>
                <div class="row" id="SucursalParaStockGeneral" style="display:none">
                        <h4>Seleccione La Sucursal De La Que Se Transferirá </h4>
                        <label class="control-label label" for="SelectSucursalParaStockGeneral">Sucursales</label>
                        <select class="span3" id="SelectSucursalParaStockGeneral" name="SelectSucursalParaStockGeneral"></select>     
                    </div>
                <div id="StockPorEntidadesGeneral" style="display:none">
                    <h3>Stock De Tarjetas Por Entidades</h3>

                    <div class="row">
                        <section>
                            <table id="tablaStockPorEntidadesGeneral"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="95%">
                                <thead class="thead-dark">
                                    <tr>
                                        <th style="text-align: center;background-color: #B0E76E">NÚMERO EMPLEADO</th>
                                        <th style="text-align: center;background-color: #B0E76E">NOMBRE EMPLEADO</th>
