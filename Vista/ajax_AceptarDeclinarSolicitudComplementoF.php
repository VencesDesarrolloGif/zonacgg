...
//$log = new KLogger ( "ajax_AceptarDeclinarSolicitudComplementoF.log" , KLogger::DEBUG );
...
try {
   $negocio->UpdateFiniquitoSolicitudComplemento($numempleado,$folioBaja,$CantidadComplemento,$opcion);
