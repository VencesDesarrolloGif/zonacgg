...
if (!empty($_POST)) {
    ...
    $empleadoId            = getValueFromPost("numempleado");
    $empleadoId = explode("-", $empleadoId);
/*
...
*/
        $entidadFederativaId=$empleadoId[0];
        $empleadoConsecutivoId=$empleadoId[1];
        $empleadoCategoriaId=$empleadoId[2];
