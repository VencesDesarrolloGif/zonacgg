   ...
   <head>
     ...
     <body>
          <div id='divMSGRepse' name='divMSGRepse' ></div>
           ...
           <div class="container top-buffer-submenu vertical-buffer">
              <button  id="btneditarREPSE"  class="btn btn-warning" onclick="editarREPSE()">Editar <span class="glyphicon glyphicon-pencil"></span></button>
              <button  id="btnguardarREPSE" disabled='true' class="btn btn-success" onclick="guardarREPSE()">Guardar</button>
           ...
           <div tabindex="-1" role="dialog" id="ModalRepse" name="ModalP" aria-labelledby="aaaa1" aria-hidden="true">
             <h1 align="center" id="procesandoRepse" name="procesandoRepse" style="display:none;" >Procesando ....</h1></div>            
           </div>  
           ...
           <script src="CatalogoRepse.js"></script>
     </body>
  </html>