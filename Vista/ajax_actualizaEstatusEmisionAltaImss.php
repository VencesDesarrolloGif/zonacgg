...
if (!empty ($_POST))
{
// $log = new KLogger ( "ajaxActualizaEstatusEmisionImss.log" , KLogger::DEBUG );
...
*/
    ...
    "emisionAltaImssConfirmada" => getValueFromPost("newEstatusEmisionAlta"),
    ...
    try
    {
        $negocio -> actualizarEstatusEmisionAltaImss($datosImss);
