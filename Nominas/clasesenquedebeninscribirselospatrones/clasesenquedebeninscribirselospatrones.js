...
function traedatos() {
    $.ajax({
        type: "POST",
        url: "ajax_catclasesenquedebeninscribirselospatrones.php",
        dataType: "json",
        success: function(response) {
            ...
            if (response.status == "success") {
                ...
                $.each(datos, function(i) {
                    tabla += "<tr><td > <input  id='inpid" + i + "' type='text' readonly='true' value='" + datos[i].numClaseInsc + "'> </td>";
...
function guardar() {
    ...
    if (inpaccion === "Agregar") {
        ...
        if (id == "") {
            ...
            $.ajax({
                type: "POST",
                url: 'insertyupdatecatclaseincripcionpatrones.php',
                data: {
