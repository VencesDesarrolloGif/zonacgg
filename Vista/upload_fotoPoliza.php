...
$keyOfFileUpload = "filefotoPoliza" . $type;
$variable13=explode("/",$_FILES[$keyOfFileUpload]["type"]);
$variable23=$variable13[0];
$variable33=$variable13[1];
$base_file_name = 
    date("Ymd_His") . "_" . 
    sha1(basename($_FILES[$keyOfFileUpload]["name"])) . ".".$variable33;
