...
//$log = new KLogger ( "subirImagenEdited.log" , KLogger::DEBUG );
...
$keyOfFileUpload = "fileFotoEmpleadoEdited" ;
...
//$log -> LogInfo ("keyOfFileUpload ".var_export ($keyOfFileUpload, true));
//$log -> LogInfo ("archivo ".var_export ($archivo, true));
//$log -> LogInfo ("target_file ".var_export ($target_file, true));
//$log -> LogInfo ("base_file_name ".var_export ($base_file_name, true));
