...
*/
    ...
    $listaEmpleados= $negocio -> getEmpleadoByIdSupervisorRangoFecha($fecha1, $fecha2, $supervisorEntidad, $supervisorConsecutivo,$supervisorTipo, $empleado);
    ...
    $listaEmpleados= $negocio -> getEmpleadoByIdRangoFecha($fecha1, $fecha2,$empleado);
