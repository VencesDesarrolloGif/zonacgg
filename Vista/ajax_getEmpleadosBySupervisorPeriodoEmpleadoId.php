...
// $log = new KLogger ( "ajaxConsultaEmpleadosBySupervisorPeriodoId.log" , KLogger::DEBUG ); 
// $log->LogInfo("Valor de variable de _SESSION" . var_export ($_SESSION, true));
...
try{
    $listaEmpleados= $negocio -> getListaEmpleadosBySupervisorPeriodoEmpleadoId($fecha1, $fecha2, $supervisorEntidad, $supervisorConsecutivo,$supervisorTipo, $periodoId, $empleado);
