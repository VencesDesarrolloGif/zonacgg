...
//$log = new KLogger ( "form_RegistroNuevaReasignacion.log" , KLogger::DEBUG );
...
if (!empty ($_POST))
{
    ...
    try
    {
        $negocio -> negocio_registrarreasignacion($NuevaReasignacion);
        $response ["status"] = "success";
        $response ["message"] = "Reasginacion Del Vehiculo Registrado Éxitosamente";    
