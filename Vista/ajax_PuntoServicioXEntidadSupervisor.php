...
//$log = new KLogger ( "ajax_PuntoServicioXEntidadSupervisor.log" , KLogger::DEBUG );
...
$clienteElegidoSupervisor = getValueFromPost ("clienteElegidoSupervisor");
$valorgifTipo=getValueFromPost ("valorgifTipo"); 

   try {
        $PuntosServicio = $negocio->obtenerPuntoXentidadSupervisor($EntidadElegida,$supervisorele,$lineaNegocio,$clienteElegidoSupervisor,$valorgifTipo);
