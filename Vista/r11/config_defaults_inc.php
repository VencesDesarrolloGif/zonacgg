...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	 ...
	 */
	$g_administrator_email	= 'noreply@gifseguridad.com.mx';

	/**
	 * Webmaster email
	 * @global string $g_webmaster_email
	 */
	$g_webmaster_email		= 'noreply@gifseguridad.com.mx';

	/**
	 * the sender email, part of 'From: ' header in emails
	 * @global string $g_from_email
	 */
 	$g_from_email			= 'noreply@gifseguridad.com.mx';

	/**
	 * the sender name, part of 'From: ' header in emails
	 * @global string $g_from_name
	 */
	$g_from_name			= 'Adminstrador Incidencias';

	/**
	 * the return address for bounced mail
	 * @global string $g_return_path_email
	 */
	$g_return_path_email	= 'noreply@gifseguridad.com.mx';
	 ...
	 */
	$g_smtp_username = 'noreply@gifseguridad.com.mx';

	/**
	 * SMTP Server Authentication password
	 * @global string $g_smtp_password
	 */
	$g_smtp_password = 'RuEsGaU1@';
	 ...
	 */
	$g_window_title			= 'Incidencias GIF';
	 ...
	 */
	$g_favicon_image		= 'images/logoGif.jpg';
