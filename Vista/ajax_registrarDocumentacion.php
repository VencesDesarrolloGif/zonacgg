...
verificarInicioSesion($negocio);
	...
	//$log = new KLogger ( "ajaxRegistroDocumentacion.log" , KLogger::DEBUG );
	...
	$documentacion = array (
		...
		"idDocumento" => getValueFromPost("documentoId"),
		"idTipoDocumento" => getValueFromPost("tipoDocumento"),
		"idEstatusDocumentos" => getValueFromPost("idEstatusDocumentos"),
...
//$log->LogInfo("Valor de la variable usuario: " . var_export ($usuario, true));    
	try
	{
		$negocio -> negocio_registrarEntregaDocumentacion($documentacion,$usuario);
