...
$EntidadDeSucursal  = $_POST["EntidadDeSucursal"];
$usuario            = $_SESSION ["userLog"]["usuario"];
$datos              = array();
//$log = new KLogger ( "ajax_ObtenerSucursalesPorEntidad.log" , KLogger::DEBUG );
//$log->LogInfo("Valor de la variable _SESSION " . var_export ($_SESSION, true));
try {
        $sql = "SELECT * FROM sucursalesinternas
                where idEntidadPerteneciente='$EntidadDeSucursal'
