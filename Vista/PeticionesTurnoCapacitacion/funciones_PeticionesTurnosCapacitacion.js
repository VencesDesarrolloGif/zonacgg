 ...
 function ConsultaPeticionesCapacitacion(){ 
    tablaPeticiones = [];
    $.ajax({
        type: "POST",
        url: "PeticionesTurnoCapacitacion/ajax_ConsultaPeticionesTurnosCapacitacion.php",
        dataType: "json",
        success: function(response) {
            if(response.status == "success") {
               ...
               for (var i = 0; i < response.datos.length; i++) {
                    ...
                    tablaPeticiones.push(record);
               }
               loadDataIntablePeticionesTurnos(tablaPeticiones);
            }else{
 ...
 var tablaDePeticionesCapacitacion = null;

 function loadDataIntablePeticionesTurnos(data) {
    if(tablaDePeticionesCapacitacion != null) {
        tablaDePeticionesCapacitacion.destroy();
    }
    tablaDePeticionesCapacitacion = $('#tablaPeticionesTurnosCapacitacion').DataTable({
     "language": {
...
function Registrarsistencia123(empleadoEntidadId,empleadoConsecutivoId,empleadoTipoId,empleadoPuntoServicioId,supervisorEntidadId,supervisorConsecutivoId,supervisorTipoId,
    incidenciaId,asistenciaFecha,comentariIncidencia1,tipoPeriodo,puestoCubiertoId,idCliente,valordia,plantilladeservicio1,idlineanegocioPunto,idpeticion,accion,idPlantillaServicio){
