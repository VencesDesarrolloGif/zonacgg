...
$puntoServicioName=getValueFromPost("puntoServicioName");
...
if($accion==0){
	$lista= $negocio -> getTabuladorSueldosByPuntoServicio($puntoServicioName);
}else if($accion==1){
	$lista= $negocio -> getTabuladorSueldosByPuntoServicioplantillasinactivas($puntoServicioName);
}
