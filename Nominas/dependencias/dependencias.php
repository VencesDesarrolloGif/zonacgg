   ...
   <head>
     ...
     <body>
          <div id='divMSGRepse' name='divMSGRepse' ></div>
           <div class="container" align="center"><h1>DEPENDENCIAS</h1></div>
           ...
           <br>
           <br>
           <div style="display: none;position: absolute;left:20%;top:40%;" id="divDatosdepartamentosSinAsignar"></div>
           <br>
           <br> 
           <div style="display: none;position: absolute;left:50%;top:40%;" id="divDatosDepartamentosAsignados"></div> 
           </center>
