...
if (!empty ($_POST))
{
//$log = new KLogger ( "ajaxInsertaActualizaDatosImss.log" , KLogger::DEBUG );
...
*/
  ...
  $usuarioCapturaImss=$_SESSION ["userLog"]["usuario"];
    ...
    try
    {
       // $negocio -> negocio_registroDatosFamiliares($datosFamiliares);
        $negocio -> negocio_insertarActualizarDatosImss($empleadoEntidad, $empleadoConsecutivo, $empleadoCategoria, $salarioDiario, $fechaImss,$numeroLote, $usuarioCapturaImss, $registroPatronal,$tipoTrabajador);
        $negocio -> negocio_actualizarEstatusEmpleado($empleadoEntidad, $empleadoConsecutivo, $empleadoCategoria, $estatusEmpleado, $usuarioCapturaImss);
