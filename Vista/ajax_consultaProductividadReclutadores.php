...
*/
	...
	try{
        ...
        {   
            ...
            $indiceRotacion=$numeroElementosActivos-$numeroElementosInactivos;
            ...
            if($indiceRotacion==0){
                $indiceRotacion1=0;
                 ...
                 if($numeroElementosActivos!=0){$indiceRotacion1=(intval($numeroElementosInactivos)/intval($numeroElementosActivos))*100;
                  $indiceRotacion1= bcdiv($indiceRotacion1, 1, 2);}else{$indiceRotacion1="0";}
            ...
            if($indiceProductividad==0){
                ...
                $indiceProductividad1=(intval($indiceProductividad)/$plantilla)*100;
                 $indiceProductividad1= bcdiv($indiceProductividad1, 1, 2) ;
