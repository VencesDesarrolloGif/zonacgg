...
try{
	...
	// $listaSupervisoresOperativos = $negocio -> negocio_obtenerSupervisoresOperativos();
	$listaSupervisoresOperativos = $negocio -> negocio_obtenerSupervisoresOperativosXNoEmpleado($usuario);
