                ...
                if($incidenciaId==4 || $incidenciaId==6 || $incidenciaId==7 || $incidenciaId==8 || $incidenciaId==10 || $incidenciaId==11 || $incidenciaId==13 || $incidenciaId==14){
                    ...
                    if(count($plantillaturnosdiaonoche)!=0){
                        ...
                        if($incidenciaId==1){// se tuvo que hace por casos ya que los descansos son variados dependiendo el rol y no se tiene una secuencia fija 
                            ...
                            }else if($IdRolOperativoPlantilla == "2" || $IdRolOperativoPlantilla==2 || $IdRolOperativoPlantilla == "7" || $IdRolOperativoPlantilla==7 || $IdRolOperativoPlantilla == "6" || $IdRolOperativoPlantilla==6){// Roles 12x12x6,12x12x5,12X24X7 formula #elementos-(TurnodDia+TurnosNoche)=DescanDiarios
                            ...
                            }else if($IdRolOperativoPlantilla == "3" || $IdRolOperativoPlantilla==3){// termina el caso 12X12X5,6,3,1, comienza el caso 12X24X7 id 5 en el catalogo roles
                                $bandera=false;
