...
$keyOfFileUpload = "filefotoFactura" . $type;
$variable1=explode("/",$_FILES[$keyOfFileUpload]["type"]);
$variable2=$variable1[0];
$variable3=$variable1[1];

$base_file_name = 
    date("Ymd_His") . "_" . 
    sha1(basename($_FILES[$keyOfFileUpload]["name"])) . ".".$variable3;
...
finfo_close($finfo);
//$log->LogInfo("Valor de fileinfo" . var_export ($fileinfo, true));
