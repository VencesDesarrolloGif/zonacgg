...
if($busqueda=='1') {
   ...
   $entidadesAconsultar = $_POST["entidadesSeleccionadas"];
}
    // $log->LogInfo("Valor de la variable entidadesAconsultar: " . var_export ($entidadesAconsultar, true)); 
try {
    ...
    // $log->LogInfo("Valor de la variable entidadesArreglo: " . var_export ($entidadesArreglo, true)); 
        $largo = count($entidadesArreglo);
        $entidadesArreglo[$largo]["idEntidadFederativa"]= $largo;
        $entidadesArreglo[$largo]["nombreEntidadFederativa"]= "Total";
        $response["entidades"]=$entidadesArreglo;
        /* PARA GENERAL TODAS LAS ENTIDADES
            $sql3="SELECT idEntidadFederativa,nombreEntidadFederativa 
                   FROM entidadesfederativas
    ...
    for($z=0; $z < count($entidadesArreglo); $z++){ 
        // $idEF= $entidadesAconsultar[$z]["idEntidadFederativa"]; 
        $idEF= $entidadesArreglo[$z]["idEntidadFederativa"]; 
        ...
        if ($idEF!='33' && $idEF!='50'){
          ...
          for($y=0; $y < count($nombreDocumentos); $y++){ 
            ...
            if($z!=$largo){
                ...
                // $log->LogInfo("Valor de la variable conteoDoc: " . var_export ($conteoDoc, true));
                if($conteoDoc=='') {
                ...
                // $log->LogInfo("Valor de la variable response11: " . var_export ($response, true));
                if($z=="0"){
                ...
                // $log->LogInfo("Valor de la variable responseSUMA: " . var_export ($response, true));
            }else{
