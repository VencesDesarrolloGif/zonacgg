...
if (empty($folio))
{
    ...
    $response = array (
        "status" => "error",
        "message" => "No se puede generar el aviso de privacidad porque no se recibió un folio válido."
    );
...
$pageCount = $pdf->setSourceFile("../archivos/expediente/avisoPrivacidad.pdf");
