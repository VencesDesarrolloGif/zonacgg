...
<section>
<center>
<select id="cuatrimestreDetalleSujetoObligado" name="cuatrimestreDetalleSujetoObligado" class="input-medium">
...
<select id="anioDetalleSujetoObligado" name="anioDetalleSujetoObligado" class="input-medium">
