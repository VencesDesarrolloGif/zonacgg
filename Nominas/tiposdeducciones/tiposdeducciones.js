        ...
        success: function(response) {
            ...
            if (response.status == "success") {
                ...
                $.each(datos, function(i) {
                    tabla += "<tr><td > <input  id='inpid" + i + "' type='text' readonly='true' value='" + datos[i].numTipoDeduccion + "'> </td>";
...
function guardar() {
    ...
    if (inpaccion === "Agregar") {
        ...
        if (id == "") {
            ...
            $.ajax({
                type: "POST",
                url: 'insertyupdatecattipodeducciones.php',
                data: {
