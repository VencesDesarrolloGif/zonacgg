<?php    
 /* CAT:Pie charts */ 
$v = isset($_GET["v3"]) ? $_GET ["v3"] : array (1);
$v2 = isset($_GET["v4"]) ? $_GET ["v4"] : array (2);
$valores = array ();
$valores2= array ();
...
for ($i = 0; $i < count($v2); $i++)
{
 ...
 $myPicture->drawText(10,13,"EGRESOS",array("R"=>255,"G"=>255,"B"=>255)); 
...
// $myPicture->setShadow(TRUE,array("X"=>3,"Y"=>3,"R"=>0,"G"=>0,"B"=>0,"Alpha"=>10)); 
 ...
 $PieChart->draw3DPie(880,350,array("WriteValues"=>TRUE,"DataGapAngle"=>10,"DataGapRadius"=>100,"Border"=>TRUE, "Radius"=>500,"Precision"=>2)); 
 ...
 //letra de descripcion de colores en vertical
 $myPicture->setFontProperties(array("FontName"=>"../libs/chart/fonts/Silkscreen.ttf","FontSize"=>12,"R"=>0,"G"=>0,"B"=>0)); //
